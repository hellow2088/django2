...
class BooksView(GenericAPIView, RetrieveModelMixin,DestroyModelMixin, ListModelMixin, UpdateModelMixin, CreateModelMixin):
...
class BooksView1(GenericAPIView, ListModelMixin):
    queryset = Book.objects.all()
    serializer_class = BookSerializer
...
class OrganizationView(View):
    ...
    def post(self, request):
        ...
        new_org = Organization.objects.create(orgname=orgname, district=district, scale=scale,
